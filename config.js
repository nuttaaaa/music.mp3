...
class EnterpriseConfigurationManager {
    ...
    constructPrimaryConfigurationSchema() {
        return {
             ...
             */
            lavalink: {
                host: EnvironmentVariableProcessor.LAVALINK_HOST || "108.181.221.203", 
                port: EnvironmentVariableProcessor.LAVALINK_PORT || 30001,       
            ...
            bot: {
                ...
                supportServer: "https://discord.gg/WZN5ARrmbX",    // 👈 Your support server link
